...
function App(): JSX.Element {
  ...
  const [myData, setMyData] = useState<GitHubData | null>(null);
  const [comparerData, setComparerData] = useState<GitHubData | null>(null);
          ...
          >
            ...
            >
              ...
              <motion.span
                ...
                initial={false}
                animate={{
                  marginLeft: haveData ? (isMobile ? "14px" : "0px") : "26px",
                }}
              >
                Comparison
              </motion.span>
            ...
            {!haveData && (
              ...
              >
                ...
                <div className="comparer-info w-5/12 text-center relative max-md:w-full">
                  {comparerError && (
                    <p className="text-red-500 absolute font-bold -bottom-4 right-20 max-md:-bottom-6">
                      {comparerError}
                    </p>
                  )}
                  <input
